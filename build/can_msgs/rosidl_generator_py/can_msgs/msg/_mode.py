...
class Mode(metaclass=Metaclass_Mode):
    ...
    def __init__(self, **kwargs):
        ...
        self.slam_mode = kwargs.get('slam_mode', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.slam_mode != other.slam_mode:
            return False
        return True
    ...
    @builtins.property
    def slam_mode(self):
        """Message field 'slam_mode'."""
        return self._slam_mode

    @slam_mode.setter
    def slam_mode(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'slam_mode' field must be of type 'bool'"
        self._slam_mode = value

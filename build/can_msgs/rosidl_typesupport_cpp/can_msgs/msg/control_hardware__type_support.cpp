...
static const _ControlHardware_type_support_symbol_names_t _ControlHardware_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, can_msgs, msg, ControlHardware)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, can_msgs, msg, ControlHardware)),
  }
};
...
{
  return &::can_msgs::msg::rosidl_typesupport_cpp::ControlHardware_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, can_msgs, msg, ControlHardware)() {
  return get_message_type_support_handle<can_msgs::msg::ControlHardware>();
}

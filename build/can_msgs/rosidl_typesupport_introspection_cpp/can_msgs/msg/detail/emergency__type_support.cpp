...
{
  new (message_memory) can_msgs::msg::Emergency(_init);
}

void Emergency_fini_function(void * message_memory)
{
  auto typed_message = static_cast<can_msgs::msg::Emergency *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Emergency_message_member_array[2] = {
  {
    ...
    offsetof(can_msgs::msg::Emergency, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_msgs::msg::Emergency, stop),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::can_msgs::msg::rosidl_typesupport_introspection_cpp::Emergency_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, can_msgs, msg, Emergency)() {
  return &::can_msgs::msg::rosidl_typesupport_introspection_cpp::Emergency_message_type_support_handle;
}

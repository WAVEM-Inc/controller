...
{
  new (message_memory) can_msgs::msg::Mode(_init);
}

void Mode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<can_msgs::msg::Mode *>(message_memory);
  typed_message->~Mode();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_message_member_array[1] = {
  {
    ...
    offsetof(can_msgs::msg::Mode, slam_mode),  // bytes offset in struct
...
{
  return &::can_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, can_msgs, msg, Mode)() {
  return &::can_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}

...
void DataRelayer::SendMessageControlSteering(float steering_angle_cmd){
  ...
  canlib_->PostCanMessage<AD_Control_Steering>(dat_1,AD_CONTROL_STEERING,device_type[CAN1]);
};
...
void DataRelayer::HeartBeat(){
  ...
  dat_5.ad_flag_msgcntr = static_cast<int>(CAN1_HEART_BEAT::FIFTEEN); // new heartbeat
	//while(true){
...
void DataRelayer::SendTest(){
  ...
  */
    ...
    void DataRelayer::static_break(UGV::BREAK break_status){
        ...
        dat_2.ad_dbs_msgcntr =  static_cast<int>(CAN1_HEART_BEAT::FIFTEEN); // new heartbeat

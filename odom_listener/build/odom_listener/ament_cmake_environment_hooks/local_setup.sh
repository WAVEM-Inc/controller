...
: ${AMENT_CURRENT_PREFIX:="/ws/controller/odom_listener/install/odom_listener"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odom_listener/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odom_listener/environment/path.sh"
